...
if(Number.NaN(input1) || Number.NaN(input2) ){
  ...
  render() {
    return (
      <div id='app'>
			  <FormComponent>
		      <InputComponent id='input1' value={this.state.input1} changeEvent={this.inputChange}/>
				  <InputComponent id='input2' value={this.state.input2} changeEvent={this.inputChange} />
